...
// 논리연산에서 무조건 true 아니면 false만 반환하는것은 아님.
...
// 3. 논리 NOT (!)
console.log(!a);       // false
console.log(!0);       // falsy한 값에 붙이면 true

/** 단축 평가
 * 표현식을 평가하는 도중 평가 결과가 확정된 경우 나머지 평가 과정을 생략하는 것
 */

// OR의 경우 'apple'이 이미 Truthy한 값이어서 true로 평가되고
// 논리 연산의 결과를 결정한 첫 번째 피연산자인 apple을 그대로 반환한다.
console.log('apple' || 'banana'); // true한 값이 앞에 있으므로 앞의 값 apple을 반환
